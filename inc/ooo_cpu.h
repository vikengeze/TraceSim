...
// filter flag for beyond page boundaries prefetches :: 1-->Morrigan acts as a filter 0-->disable filtering
#define BPBP_FILTER 0
...
class O3_CPU {
  ...
  int prefetch_code_line(uint64_t pf_v_addr, bool cross_pb); 
};
