...
#define DRAM_WQ_SIZE 64//48 //64
#define DRAM_RQ_SIZE 64//48 //64

#define tRP_DRAM_NANOSECONDS  12.5 //12
#define tRCD_DRAM_NANOSECONDS 12.5 //12 //12.5
#define tCAS_DRAM_NANOSECONDS 12.5 //12 //12.5
